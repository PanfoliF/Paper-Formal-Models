...
Causal inference (\cite{pearl_causality_2009}) suggests that in order to answer this question we may also think of a "variable" that we are mistakenly excluding from the framework. My guess is that in this context this missing variable exists.
