...
I will therefore continue my article in the belief that the animal-world examples: 

\begin{itemize}
  \item \textcolor{red}{change the way we theorise a broader set of agents and interactions.}
  \item \textcolor{red}{will reinforce the empirical evidence presented by Safina}
  \item \textcolor{red}{will provide a new equilibrioum concept.}
  \item \textcolor{red}{will contribute to the theoretical assumptions underlying game-theoretic models}
\end{itemize}
