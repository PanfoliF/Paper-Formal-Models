...
In this section I propose a readaptation of a famous model \parencite{grosecloseBuyingSupermajorities1996}. I intend to exploit the genious equilibrioum authors found, to support the intuition coming from the DAG with another nerrative. In doing so, I believe we are improving the previous model (See \autoref{sub:model1}: \nameref{sub:model1}).
