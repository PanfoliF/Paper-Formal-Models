...
\begin{itemize}
  \item \textcolor{red}{Citazione Battigalli su perfect and imperfect information}
  \item \textcolor{red}{Ci sono 3 contraddizioni da prendere in considerazione.}
  \begin{enumerate}
    \item \textcolor{red}{perché prima attacca e poi aiuta? "non è razionale"}
    \item \textcolor{red}{perché in un caso attacca e nell'altro no?}
    \item \textcolor{red}{cosa è razionele? attaccare e tornare indietro o non attaccare? Quale delle due strategie è la migliore? è la migliore rispetto a cosa?}
  \end{enumerate}
\end{itemize}
...
In this section I propose a readaptation of a famous model \parencite{grosecloseBuyingSupermajorities1996}. I intend to exploit the genious equilibrioum authors found, to support the intuition coming from the DAG with another nerrative. In doing so, I believe we are improving the previous model and we are getting closer to the final aim of representing a real world event.
