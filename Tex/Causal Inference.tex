...
The next step is to use causal inference. Why? because we want again to produce a general case, to pass from the individuality of that interaction to the a \textcite{new} general case we need to discard irrelevant differences and variables, and we need to identify a common mechanism. In this way we can produce a new pattern, which will constitute a new map, indeed.

\subsection*{DAGs}
\begin{figure}[htpb] %  figure placement: here, top, bottom, or page
   \centering
   \includegraphics[width=0.4\linewidth]{Tex/Brauninger.jpg}
