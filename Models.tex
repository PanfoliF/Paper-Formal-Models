...
\vspace*{1em}
The decisive variable in this situation may be the element of surprise (\cite{schelling_strategy_1960}).
...
This setup corresponds to the classical \textit{vote-buying game} as formalized by (\cite{groseclose_buying_1996}).
